...
$MethodInfo KeyBoardNavigation$$Lambda$lambda$init$0::methodInfos[3] = {
	{"<init>", "(LKeyBoardNavigation;)V", nullptr, $PUBLIC, $method(static_cast<void(KeyBoardNavigation$$Lambda$lambda$init$0::*)(KeyBoardNavigation*)>(&KeyBoardNavigation$$Lambda$lambda$init$0::init$))},
...
$MethodInfo _KeyBoardNavigation_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(KeyBoardNavigation::*)()>(&KeyBoardNavigation::init$))},
	{"init", "()V", nullptr, $PUBLIC},
	{"initTest", "(Ljava/awt/Container;)V", nullptr, $STATIC, $method(static_cast<void(*)($Container*)>(&KeyBoardNavigation::initTest))},
	{"lambda$init$0", "()V", nullptr, $PRIVATE | $SYNTHETIC, $method(static_cast<void(KeyBoardNavigation::*)()>(&KeyBoardNavigation::lambda$init$0))},
	{}
};
