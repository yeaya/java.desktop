...
$MethodInfo _HeadlessJTabbedPane_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(HeadlessJTabbedPane::*)()>(&HeadlessJTabbedPane::init$))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($StringArray*)>(&HeadlessJTabbedPane::main))},
	{}
};
