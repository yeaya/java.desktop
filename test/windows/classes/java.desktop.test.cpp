...
::java::lang::ClassEntry _java$desktop$test_classes_[] = {
	...
	$classEntry("bug6263446$1", ::bug6263446$1),
	$classEntry("bug6263446$2", ::bug6263446$2),
	$classEntry("bug6263446$3", ::bug6263446$3),
	$classEntry("bug6263446$4", ::bug6263446$4),
	$classEntry("bug6263446$5", ::bug6263446$5),
	$classEntry("bug6263446$6", ::bug6263446$6),
	$classEntry("bug6263446$7", ::bug6263446$7),
...
void java$desktop$test$PreloadClass(void* eventData) {
...
void java$desktop$test$LibEventAction(int32_t eventType, void* eventData) {
	if (eventType == JCPP_LIB_EVENT_TYPE_PRELOAD_CLASS) {
		java$desktop$test$PreloadClass(eventData);
	}
