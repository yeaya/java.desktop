...
$MethodInfo RootPaneDecorationSize$$Lambda$lambda$main$0::methodInfos[3] = {
	{"<init>", "(Ljavax/swing/UIManager$LookAndFeelInfo;)V", nullptr, $PUBLIC, $method(static_cast<void(RootPaneDecorationSize$$Lambda$lambda$main$0::*)($UIManager$LookAndFeelInfo*)>(&RootPaneDecorationSize$$Lambda$lambda$main$0::init$))},
...
$MethodInfo RootPaneDecorationSize$$Lambda$test$1::methodInfos[3] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(RootPaneDecorationSize$$Lambda$test$1::*)()>(&RootPaneDecorationSize$$Lambda$test$1::init$))},
	{"run", "()V", nullptr, $PUBLIC},
	{}
};
...
$MethodInfo _RootPaneDecorationSize_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(RootPaneDecorationSize::*)()>(&RootPaneDecorationSize::init$))},
	{"lambda$main$0", "(Ljavax/swing/UIManager$LookAndFeelInfo;)V", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<void(*)($UIManager$LookAndFeelInfo*)>(&RootPaneDecorationSize::lambda$main$0))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($StringArray*)>(&RootPaneDecorationSize::main)), "java.lang.Exception"},
	{"setLookAndFeel", "(Ljavax/swing/UIManager$LookAndFeelInfo;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($UIManager$LookAndFeelInfo*)>(&RootPaneDecorationSize::setLookAndFeel))},
	{"test", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&RootPaneDecorationSize::test))},
	{}
};
