...
using $HeadlessJDesktopPane$1 = ::HeadlessJDesktopPane$1;
using $HeadlessJDesktopPane$2 = ::HeadlessJDesktopPane$2;
using $HeadlessJDesktopPane$3 = ::HeadlessJDesktopPane$3;
using $HeadlessJDesktopPane$4 = ::HeadlessJDesktopPane$4;
...
$MethodInfo _HeadlessJDesktopPane_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(HeadlessJDesktopPane::*)()>(&HeadlessJDesktopPane::init$))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($StringArray*)>(&HeadlessJDesktopPane::main))},
	{}
};

$InnerClassInfo _HeadlessJDesktopPane_InnerClassesInfo_[] = {
...
$ClassInfo _HeadlessJDesktopPane_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"HeadlessJDesktopPane",
	"java.lang.Object",
	nullptr,
	nullptr,
	_HeadlessJDesktopPane_MethodInfo_,
	nullptr,
	nullptr,
	_HeadlessJDesktopPane_InnerClassesInfo_,
	nullptr,
	nullptr,
	"HeadlessJDesktopPane$4,HeadlessJDesktopPane$3,HeadlessJDesktopPane$2,HeadlessJDesktopPane$1"
};

$Object* allocate$HeadlessJDesktopPane($Class* clazz) {
	return $of($alloc(HeadlessJDesktopPane));
}

void HeadlessJDesktopPane::init$() {
}
...
void HeadlessJDesktopPane::main($StringArray* args) {
	...
	ch->getMinimumSize();
	ch->contains(1, 2);
	$var($Component, c1, ch->add(static_cast<$Component*>($$new($HeadlessJDesktopPane$2))));
	$var($Component, c2, ch->add(static_cast<$Component*>($$new($HeadlessJDesktopPane$3))));
	$var($Component, c3, ch->add(static_cast<$Component*>($$new($HeadlessJDesktopPane$4))));
...
HeadlessJDesktopPane::HeadlessJDesktopPane() {
}

$Class* HeadlessJDesktopPane::load$($String* name, bool initialize) {
	$loadClass(HeadlessJDesktopPane, name, initialize, &_HeadlessJDesktopPane_ClassInfo_, allocate$HeadlessJDesktopPane);
	return class$;
}

$Class* HeadlessJDesktopPane::class$ = nullptr;