...
public:
	...
	static const int8_t SHIFT = 42; // ::apple::laf::JRSUIConstants$BooleanValue::SHIFT + ::apple::laf::JRSUIConstants$BooleanValue::SIZE
	static const int8_t SIZE = 1;
	static const int64_t MASK = 4398046511104; // (int64_t)1 << SHIFT
