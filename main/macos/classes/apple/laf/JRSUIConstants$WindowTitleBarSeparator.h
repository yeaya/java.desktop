...
public:
	...
	static const int8_t SHIFT = 38; // ::apple::laf::JRSUIConstants$NothingToScroll::SHIFT + ::apple::laf::JRSUIConstants$NothingToScroll::SIZE
	static const int8_t SIZE = 1;
	static const int64_t MASK = 274877906944; // (int64_t)1 << SHIFT
