...
public:
	...
	static const int8_t SHIFT = 32; // ::apple::laf::JRSUIConstants$IndicatorOnly::SHIFT + ::apple::laf::JRSUIConstants$IndicatorOnly::SIZE
	static const int8_t SIZE = 1;
	static const int64_t MASK = 4294967296; // (int64_t)1 << SHIFT
