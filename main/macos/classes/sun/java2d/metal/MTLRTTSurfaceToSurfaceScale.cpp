...
$MethodInfo _MTLRTTSurfaceToSurfaceScale_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MTLRTTSurfaceToSurfaceScale::*)()>(&MTLRTTSurfaceToSurfaceScale::init$))},
...
void MTLRTTSurfaceToSurfaceScale::init$() {
	$init($MTLSurfaceData);
	$init($CompositeType);
	$ScaledBlit::init$($MTLSurfaceData::MTLSurfaceRTT, $CompositeType::AnyAlpha, $MTLSurfaceData::MTLSurface);
}

void MTLRTTSurfaceToSurfaceScale::Scale($SurfaceData* src, $SurfaceData* dst, $Composite* comp, $Region* clip, int32_t sx1, int32_t sy1, int32_t sx2, int32_t sy2, double dx1, double dy1, double dx2, double dy2) {
...
MTLRTTSurfaceToSurfaceScale::MTLRTTSurfaceToSurfaceScale() {
}
...
$Class* MTLRTTSurfaceToSurfaceScale::class$ = nullptr;
