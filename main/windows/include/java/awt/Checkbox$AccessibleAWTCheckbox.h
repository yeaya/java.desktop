...
class $import Checkbox$AccessibleAWTCheckbox : public ::java::awt::Component$AccessibleAWTComponent, public ::java::awt::event::ItemListener, public ::javax::accessibility::AccessibleAction, public ::javax::accessibility::AccessibleValue {
