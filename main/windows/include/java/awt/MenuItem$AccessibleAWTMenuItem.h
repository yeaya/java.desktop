...
class $import MenuItem$AccessibleAWTMenuItem : public ::java::awt::MenuComponent$AccessibleAWTMenuComponent, public ::javax::accessibility::AccessibleAction, public ::javax::accessibility::AccessibleValue {
