...
class $import BeanContextServicesSupport$BCSSProxyServiceProvider : public ::java::beans::beancontext::BeanContextServiceProvider, public ::java::beans::beancontext::BeanContextServiceRevokedListener {
