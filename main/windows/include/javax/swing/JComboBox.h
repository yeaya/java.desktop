...
class $import JComboBox : public ::javax::swing::JComponent, public ::java::awt::ItemSelectable, public ::javax::swing::event::ListDataListener, public ::java::awt::event::ActionListener, public ::javax::accessibility::Accessible {
