...
class $import JTabbedPane$AccessibleJTabbedPane : public ::javax::swing::JComponent$AccessibleJComponent, public ::javax::accessibility::AccessibleSelection, public ::javax::swing::event::ChangeListener {
