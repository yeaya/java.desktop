...
class $import JList$AccessibleJList : public ::javax::swing::JComponent$AccessibleJComponent, public ::javax::accessibility::AccessibleSelection, public ::java::beans::PropertyChangeListener, public ::javax::swing::event::ListSelectionListener, public ::javax::swing::event::ListDataListener {
