...
class $import AbstractDocument$DefaultDocumentEventUndoableWrapper : public ::javax::swing::text::AbstractDocument$DefaultDocumentEvent, public ::sun::swing::text::UndoableEditLockSupport {
