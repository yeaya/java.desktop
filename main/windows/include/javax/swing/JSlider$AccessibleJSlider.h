...
class $import JSlider$AccessibleJSlider : public ::javax::swing::JComponent$AccessibleJComponent, public ::javax::accessibility::AccessibleValue, public ::javax::swing::event::ChangeListener, public ::javax::accessibility::AccessibleAction {
