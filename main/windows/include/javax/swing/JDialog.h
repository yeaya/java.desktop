...
class $import JDialog : public ::java::awt::Dialog, public ::javax::swing::WindowConstants, public ::javax::swing::RootPaneContainer, public ::javax::swing::TransferHandler$HasGetTransferHandler {
