...
class $import SynthToolBarUI : public ::javax::swing::plaf::basic::BasicToolBarUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
