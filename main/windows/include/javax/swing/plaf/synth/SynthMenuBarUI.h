...
class $import SynthMenuBarUI : public ::javax::swing::plaf::basic::BasicMenuBarUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
