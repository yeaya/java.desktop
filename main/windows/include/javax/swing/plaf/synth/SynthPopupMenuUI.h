#ifndef _javax_swing_plaf_synth_SynthPopupMenuUI_h_
#define _javax_swing_plaf_synth_SynthPopupMenuUI_h_
...
class $import SynthPopupMenuUI : public ::javax::swing::plaf::basic::BasicPopupMenuUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
	$class(SynthPopupMenuUI, $NO_CLASS_INIT, ::javax::swing::plaf::basic::BasicPopupMenuUI, ::java::beans::PropertyChangeListener, ::javax::swing::plaf::synth::SynthUI)
public:
	SynthPopupMenuUI();
...
#endif // _javax_swing_plaf_synth_SynthPopupMenuUI_h_