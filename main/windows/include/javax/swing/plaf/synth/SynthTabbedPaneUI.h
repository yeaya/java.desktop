...
class $import SynthTabbedPaneUI : public ::javax::swing::plaf::basic::BasicTabbedPaneUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
