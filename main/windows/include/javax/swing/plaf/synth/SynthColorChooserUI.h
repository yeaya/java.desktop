...
class $import SynthColorChooserUI : public ::javax::swing::plaf::basic::BasicColorChooserUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
