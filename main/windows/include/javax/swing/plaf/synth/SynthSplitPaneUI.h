...
class $import SynthSplitPaneUI : public ::javax::swing::plaf::basic::BasicSplitPaneUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
