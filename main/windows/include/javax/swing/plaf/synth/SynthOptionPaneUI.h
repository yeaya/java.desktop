...
class $import SynthOptionPaneUI : public ::javax::swing::plaf::basic::BasicOptionPaneUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
