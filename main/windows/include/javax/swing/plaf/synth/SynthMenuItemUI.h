...
class $import SynthMenuItemUI : public ::javax::swing::plaf::basic::BasicMenuItemUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
