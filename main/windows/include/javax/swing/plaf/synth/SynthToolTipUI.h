...
class $import SynthToolTipUI : public ::javax::swing::plaf::basic::BasicToolTipUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
