...
class $import SynthInternalFrameUI : public ::javax::swing::plaf::basic::BasicInternalFrameUI, public ::javax::swing::plaf::synth::SynthUI, public ::java::beans::PropertyChangeListener {
