...
class $import SynthDesktopIconUI : public ::javax::swing::plaf::basic::BasicDesktopIconUI, public ::javax::swing::plaf::synth::SynthUI, public ::java::beans::PropertyChangeListener {
