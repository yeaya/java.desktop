...
class $import SynthScrollPaneUI : public ::javax::swing::plaf::basic::BasicScrollPaneUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
