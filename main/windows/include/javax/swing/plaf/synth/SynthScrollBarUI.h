...
class $import SynthScrollBarUI : public ::javax::swing::plaf::basic::BasicScrollBarUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
