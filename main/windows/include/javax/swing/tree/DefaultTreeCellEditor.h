...
class $import DefaultTreeCellEditor : public ::java::awt::event::ActionListener, public ::javax::swing::tree::TreeCellEditor, public ::javax::swing::event::TreeSelectionListener {
