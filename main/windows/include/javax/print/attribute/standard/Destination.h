...
class $import Destination : public ::javax::print::attribute::URISyntax, public ::javax::print::attribute::PrintJobAttribute, public ::javax::print::attribute::PrintRequestAttribute {
