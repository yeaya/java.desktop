...
$MethodInfo _GTKKeybindings_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(GTKKeybindings::*)()>(&GTKKeybindings::init$))},
	{"installKeybindings", "(Ljavax/swing/UIDefaults;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($UIDefaults*)>(&GTKKeybindings::installKeybindings))},
	{}
};
