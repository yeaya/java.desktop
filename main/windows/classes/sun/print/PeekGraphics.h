#ifndef _sun_print_PeekGraphics_h_
#define _sun_print_PeekGraphics_h_
//$ class sun.print.PeekGraphics
//$ extends java.awt.Graphics2D
//$ implements java.awt.print.PrinterGraphics,java.awt.image.ImageObserver,java.lang.Cloneable
...
class PeekGraphics : public ::java::awt::Graphics2D, public ::java::awt::print::PrinterGraphics, public ::java::awt::image::ImageObserver, public ::java::lang::Cloneable {
...
public:
	...
	void addDrawingRect(::java::awt::geom::Rectangle2D* rect, float x, float y);
	void addDrawingRect(float x, float y, float width, float height);
	void addDrawingRect(::java::awt::geom::Rectangle2D* rect);
	virtual void addRenderingHints(::java::util::Map* hints) override;
	void addStrokeShape(::java::awt::Shape* s);
	...
	virtual bool getAWTDrawingOnly();
	...
	virtual ::sun::java2d::Spans* getDrawingArea();
	...
	int32_t getImageHeight(::java::awt::Image* img);
	int32_t getImageWidth(::java::awt::Image* img);
	virtual ::sun::print::PeekMetrics* getMetrics();
	...
	virtual bool hitsDrawingArea(::java::awt::Rectangle* rect);
	...
	virtual void setAWTDrawingOnly();
	...
	::sun::java2d::Spans* mDrawingArea = nullptr;
	::sun::print::PeekMetrics* mPrintMetrics = nullptr;
	bool mAWTDrawingOnly = false;
};

	} // print
} // sun

#endif // _sun_print_PeekGraphics_h_