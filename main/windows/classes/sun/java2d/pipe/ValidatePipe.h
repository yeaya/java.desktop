#ifndef _sun_java2d_pipe_ValidatePipe_h_
#define _sun_java2d_pipe_ValidatePipe_h_
//$ class sun.java2d.pipe.ValidatePipe
...
class ValidatePipe : public ::sun::java2d::pipe::PixelDrawPipe, public ::sun::java2d::pipe::PixelFillPipe, public ::sun::java2d::pipe::ShapeDrawPipe, public ::sun::java2d::pipe::TextPipe, public ::sun::java2d::pipe::DrawImagePipe {
	$class(ValidatePipe, $NO_CLASS_INIT, ::sun::java2d::pipe::PixelDrawPipe, ::sun::java2d::pipe::PixelFillPipe, ::sun::java2d::pipe::ShapeDrawPipe, ::sun::java2d::pipe::TextPipe, ::sun::java2d::pipe::DrawImagePipe)
public:
	ValidatePipe();
	...
	virtual bool validate(::sun::java2d::SunGraphics2D* sg);
};
...
#endif // _sun_java2d_pipe_ValidatePipe_h_