#ifndef _sun_awt_windows_WDialogPeer_h_
#define _sun_awt_windows_WDialogPeer_h_
//$ class sun.awt.windows.WDialogPeer
...
class WDialogPeer : public ::sun::awt::windows::WWindowPeer, public ::java::awt::peer::DialogPeer {
...
public:
	...
	void createAwtDialog(::sun::awt::windows::WComponentPeer* parent);
	void endModal();
	...
	void pSetIMMOption($String* option);
	virtual void paint(::java::awt::Graphics* g) override;
	virtual void print(::java::awt::Graphics* g) override;
	virtual void realShow() override;
...
#endif // _sun_awt_windows_WDialogPeer_h_