...
$MethodInfo _MetaData$java_awt_List_PersistenceDelegate_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MetaData$java_awt_List_PersistenceDelegate::*)()>(&MetaData$java_awt_List_PersistenceDelegate::init$))},
...
$InnerClassInfo _MetaData$java_awt_List_PersistenceDelegate_InnerClassesInfo_[] = {
	{"java.beans.MetaData$java_awt_List_PersistenceDelegate", "java.beans.MetaData", "java_awt_List_PersistenceDelegate", $STATIC | $FINAL},
	{}
};

$ClassInfo _MetaData$java_awt_List_PersistenceDelegate_ClassInfo_ = {
	$FINAL | $ACC_SUPER,
	"java.beans.MetaData$java_awt_List_PersistenceDelegate",
	"java.beans.DefaultPersistenceDelegate",
	nullptr,
	nullptr,
	_MetaData$java_awt_List_PersistenceDelegate_MethodInfo_,
	nullptr,
	nullptr,
	_MetaData$java_awt_List_PersistenceDelegate_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"java.beans.MetaData"
...
$Object* allocate$MetaData$java_awt_List_PersistenceDelegate($Class* clazz) {
	return $of($alloc(MetaData$java_awt_List_PersistenceDelegate));
}
...
$Class* MetaData$java_awt_List_PersistenceDelegate::load$($String* name, bool initialize) {
	$loadClass(MetaData$java_awt_List_PersistenceDelegate, name, initialize, &_MetaData$java_awt_List_PersistenceDelegate_ClassInfo_, allocate$MetaData$java_awt_List_PersistenceDelegate);
	return class$;
}
