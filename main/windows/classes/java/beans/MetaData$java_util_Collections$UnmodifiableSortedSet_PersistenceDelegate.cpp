...
$MethodInfo _MetaData$java_util_Collections$UnmodifiableSortedSet_PersistenceDelegate_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MetaData$java_util_Collections$UnmodifiableSortedSet_PersistenceDelegate::*)()>(&MetaData$java_util_Collections$UnmodifiableSortedSet_PersistenceDelegate::init$))},
