...
$MethodInfo _MetaData$java_util_Collections$SingletonSet_PersistenceDelegate_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MetaData$java_util_Collections$SingletonSet_PersistenceDelegate::*)()>(&MetaData$java_util_Collections$SingletonSet_PersistenceDelegate::init$))},
