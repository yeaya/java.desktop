...
class $export BeanContextSupport : public ::java::beans::beancontext::BeanContextChildSupport, public ::java::beans::beancontext::BeanContext, public ::java::beans::PropertyChangeListener, public ::java::beans::VetoableChangeListener {
