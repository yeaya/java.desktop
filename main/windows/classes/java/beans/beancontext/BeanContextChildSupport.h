...
class $export BeanContextChildSupport : public ::java::beans::beancontext::BeanContextChild, public ::java::beans::beancontext::BeanContextServicesListener, public ::java::io::Serializable {
