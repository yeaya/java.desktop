...
$MethodInfo _MetaData$java_awt_font_TextAttribute_PersistenceDelegate_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MetaData$java_awt_font_TextAttribute_PersistenceDelegate::*)()>(&MetaData$java_awt_font_TextAttribute_PersistenceDelegate::init$))},
	{}
};
