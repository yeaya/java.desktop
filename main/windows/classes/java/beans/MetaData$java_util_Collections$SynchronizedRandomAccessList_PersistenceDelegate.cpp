...
$MethodInfo _MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate::*)()>(&MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate::init$))},
	{"instantiate", "(Ljava/lang/Object;Ljava/beans/Encoder;)Ljava/beans/Expression;", nullptr, $PROTECTED},
	{}
};

$InnerClassInfo _MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate_InnerClassesInfo_[] = {
...
$ClassInfo _MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate_ClassInfo_ = {
	$FINAL | $ACC_SUPER,
	...
	nullptr,
	nullptr,
	_MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate_MethodInfo_,
	nullptr,
	nullptr,
	_MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"java.beans.MetaData"
...
$Object* allocate$MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate($Class* clazz) {
	return $of($alloc(MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate));
}
...
$Expression* MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate::instantiate(Object$* oldInstance, $Encoder* out) {
	...
	$load($Collections);
	return $new($Expression, oldInstance, $Collections::class$, "synchronizedList"_s, $$new($ObjectArray, {$of(list)}));
}
...
$Class* MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate::load$($String* name, bool initialize) {
	$loadClass(MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate, name, initialize, &_MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate_ClassInfo_, allocate$MetaData$java_util_Collections$SynchronizedRandomAccessList_PersistenceDelegate);
	return class$;
}
