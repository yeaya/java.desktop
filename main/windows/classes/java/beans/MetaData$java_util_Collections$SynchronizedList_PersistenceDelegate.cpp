...
$MethodInfo _MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate::*)()>(&MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate::init$))},
	{"instantiate", "(Ljava/lang/Object;Ljava/beans/Encoder;)Ljava/beans/Expression;", nullptr, $PROTECTED},
	{}
};

$InnerClassInfo _MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate_InnerClassesInfo_[] = {
...
$ClassInfo _MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate_ClassInfo_ = {
	$FINAL | $ACC_SUPER,
	"java.beans.MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate",
	"java.beans.MetaData$java_util_Collections",
	nullptr,
	nullptr,
	_MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate_MethodInfo_,
	nullptr,
	nullptr,
	_MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"java.beans.MetaData"
...
$Object* allocate$MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate($Class* clazz) {
	return $of($alloc(MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate));
}
...
$Class* MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate::load$($String* name, bool initialize) {
	$loadClass(MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate, name, initialize, &_MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate_ClassInfo_, allocate$MetaData$java_util_Collections$SynchronizedList_PersistenceDelegate);
	return class$;
}
