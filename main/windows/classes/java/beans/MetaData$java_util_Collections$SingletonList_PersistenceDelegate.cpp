...
$MethodInfo _MetaData$java_util_Collections$SingletonList_PersistenceDelegate_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MetaData$java_util_Collections$SingletonList_PersistenceDelegate::*)()>(&MetaData$java_util_Collections$SingletonList_PersistenceDelegate::init$))},
...
MetaData$java_util_Collections$SingletonList_PersistenceDelegate::MetaData$java_util_Collections$SingletonList_PersistenceDelegate() {
}
...
$Class* MetaData$java_util_Collections$SingletonList_PersistenceDelegate::class$ = nullptr;
