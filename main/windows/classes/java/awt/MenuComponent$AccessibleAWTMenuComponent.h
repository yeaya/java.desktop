...
class $export MenuComponent$AccessibleAWTMenuComponent : public ::javax::accessibility::AccessibleContext, public ::java::io::Serializable, public ::javax::accessibility::AccessibleComponent, public ::javax::accessibility::AccessibleSelection {
