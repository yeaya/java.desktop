...
class $export WindowsBorders$ToolBarBorder : public ::javax::swing::border::AbstractBorder, public ::javax::swing::plaf::UIResource, public ::javax::swing::SwingConstants {
