...
class $export WindowsIconFactory$VistaMenuItemCheckIconFactory$VistaMenuItemCheckIcon : public ::javax::swing::Icon, public ::javax::swing::plaf::UIResource, public ::java::io::Serializable {
