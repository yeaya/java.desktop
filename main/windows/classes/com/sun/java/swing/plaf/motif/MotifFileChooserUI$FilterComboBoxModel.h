#ifndef _com_sun_java_swing_plaf_motif_MotifFileChooserUI$FilterComboBoxModel_h_
#define _com_sun_java_swing_plaf_motif_MotifFileChooserUI$FilterComboBoxModel_h_
//$ class com.sun.java.swing.plaf.motif.MotifFileChooserUI$FilterComboBoxModel
...
class $export MotifFileChooserUI$FilterComboBoxModel : public ::javax::swing::AbstractListModel, public ::javax::swing::ComboBoxModel, public ::java::beans::PropertyChangeListener {
	$class(MotifFileChooserUI$FilterComboBoxModel, $NO_CLASS_INIT, ::javax::swing::AbstractListModel, ::javax::swing::ComboBoxModel, ::java::beans::PropertyChangeListener)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifFileChooserUI$FilterComboBoxModel_h_