...
class $export MotifInternalFrameTitlePane : public ::javax::swing::plaf::basic::BasicInternalFrameTitlePane, public ::java::awt::LayoutManager, public ::java::awt::event::ActionListener, public ::java::beans::PropertyChangeListener {
