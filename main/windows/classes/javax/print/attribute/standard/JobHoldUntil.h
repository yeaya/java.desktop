...
class $export JobHoldUntil : public ::javax::print::attribute::DateTimeSyntax, public ::javax::print::attribute::PrintRequestAttribute, public ::javax::print::attribute::PrintJobAttribute {
