...
class $export JLayer : public ::javax::swing::JComponent, public ::javax::swing::Scrollable, public ::java::beans::PropertyChangeListener, public ::javax::accessibility::Accessible {
