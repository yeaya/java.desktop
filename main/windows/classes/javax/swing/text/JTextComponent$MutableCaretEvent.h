...
class $export JTextComponent$MutableCaretEvent : public ::javax::swing::event::CaretEvent, public ::javax::swing::event::ChangeListener, public ::java::awt::event::FocusListener, public ::java::awt::event::MouseListener {
