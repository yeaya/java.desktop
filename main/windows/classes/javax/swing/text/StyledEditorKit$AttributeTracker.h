...
class $export StyledEditorKit$AttributeTracker : public ::javax::swing::event::CaretListener, public ::java::beans::PropertyChangeListener, public ::java::io::Serializable {
