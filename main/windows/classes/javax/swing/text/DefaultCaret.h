...
class $export DefaultCaret : public ::java::awt::Rectangle, public ::javax::swing::text::Caret, public ::java::awt::event::FocusListener, public ::java::awt::event::MouseListener, public ::java::awt::event::MouseMotionListener {
