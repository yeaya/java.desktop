...
class $export StyleConstants$ColorConstants : public ::javax::swing::text::StyleConstants, public ::javax::swing::text::AttributeSet$ColorAttribute, public ::javax::swing::text::AttributeSet$CharacterAttribute {
