...
class $export DefaultCaret$Handler : public ::java::beans::PropertyChangeListener, public ::javax::swing::event::DocumentListener, public ::java::awt::event::ActionListener, public ::java::awt::datatransfer::ClipboardOwner {
