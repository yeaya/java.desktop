...
class $export JEditorPane$JEditorPaneAccessibleHypertextSupport : public ::javax::swing::JEditorPane$AccessibleJEditorPane, public ::javax::accessibility::AccessibleHypertext {
