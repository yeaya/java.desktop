#ifndef _javax_swing_plaf_metal_MetalBorders$ButtonBorder_h_
#define _javax_swing_plaf_metal_MetalBorders$ButtonBorder_h_
...
class $export MetalBorders$ButtonBorder : public ::javax::swing::border::AbstractBorder, public ::javax::swing::plaf::UIResource {
...
public:
	...
	void paintOceanBorder(::java::awt::Component* c, ::java::awt::Graphics* g, int32_t x, int32_t y, int32_t w, int32_t h);
...
#endif // _javax_swing_plaf_metal_MetalBorders$ButtonBorder_h_