...
$FieldInfo _MultiPanelUI_FieldInfo_[] = {
	{"uis", "Ljava/util/Vector;", "Ljava/util/Vector<Ljavax/swing/plaf/ComponentUI;>;", $PROTECTED, $field(MultiPanelUI, uis)},
	{}
};

$MethodInfo _MultiPanelUI_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(MultiPanelUI::*)()>(&MultiPanelUI::init$))},
	{"contains", "(Ljavax/swing/JComponent;II)Z", nullptr, $PUBLIC},
	{"createUI", "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$ComponentUI*(*)($JComponent*)>(&MultiPanelUI::createUI))},
...
$ClassInfo _MultiPanelUI_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"javax.swing.plaf.multi.MultiPanelUI",
	"javax.swing.plaf.PanelUI",
	nullptr,
	_MultiPanelUI_FieldInfo_,
	_MultiPanelUI_MethodInfo_
};

$Object* allocate$MultiPanelUI($Class* clazz) {
	return $of($alloc(MultiPanelUI));
}
...
$Class* MultiPanelUI::load$($String* name, bool initialize) {
	$loadClass(MultiPanelUI, name, initialize, &_MultiPanelUI_ClassInfo_, allocate$MultiPanelUI);
	return class$;
}
