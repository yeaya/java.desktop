...
$FieldInfo _MultiDesktopIconUI_FieldInfo_[] = {
	{"uis", "Ljava/util/Vector;", "Ljava/util/Vector<Ljavax/swing/plaf/ComponentUI;>;", $PROTECTED, $field(MultiDesktopIconUI, uis)},
	{}
};

$MethodInfo _MultiDesktopIconUI_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(MultiDesktopIconUI::*)()>(&MultiDesktopIconUI::init$))},
	{"contains", "(Ljavax/swing/JComponent;II)Z", nullptr, $PUBLIC},
	{"createUI", "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$ComponentUI*(*)($JComponent*)>(&MultiDesktopIconUI::createUI))},
...
$ClassInfo _MultiDesktopIconUI_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"javax.swing.plaf.multi.MultiDesktopIconUI",
	"javax.swing.plaf.DesktopIconUI",
	nullptr,
	_MultiDesktopIconUI_FieldInfo_,
	_MultiDesktopIconUI_MethodInfo_
};

$Object* allocate$MultiDesktopIconUI($Class* clazz) {
	return $of($alloc(MultiDesktopIconUI));
}

void MultiDesktopIconUI::init$() {
	$DesktopIconUI::init$();
	$set(this, uis, $new($Vector));
}

$ComponentUIArray* MultiDesktopIconUI::getUIs() {
	return $MultiLookAndFeel::uisToArray(this->uis);
}

bool MultiDesktopIconUI::contains($JComponent* a, int32_t b, int32_t c) {
...
$ComponentUI* MultiDesktopIconUI::createUI($JComponent* a) {
	$init(MultiDesktopIconUI);
	$var(MultiDesktopIconUI, mui, $new(MultiDesktopIconUI));
...
int32_t MultiDesktopIconUI::getAccessibleChildrenCount($JComponent* a) {
...
$Accessible* MultiDesktopIconUI::getAccessibleChild($JComponent* a, int32_t b) {
...
MultiDesktopIconUI::MultiDesktopIconUI() {
}

$Class* MultiDesktopIconUI::load$($String* name, bool initialize) {
	$loadClass(MultiDesktopIconUI, name, initialize, &_MultiDesktopIconUI_ClassInfo_, allocate$MultiDesktopIconUI);
	return class$;
}

$Class* MultiDesktopIconUI::class$ = nullptr;
