...
$MethodInfo _MultiSeparatorUI_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(MultiSeparatorUI::*)()>(&MultiSeparatorUI::init$))},
	{"contains", "(Ljavax/swing/JComponent;II)Z", nullptr, $PUBLIC},
	{"createUI", "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$ComponentUI*(*)($JComponent*)>(&MultiSeparatorUI::createUI))},
...
$ComponentUIArray* MultiSeparatorUI::getUIs() {
...
$ComponentUI* MultiSeparatorUI::createUI($JComponent* a) {
	$init(MultiSeparatorUI);
	$var(MultiSeparatorUI, mui, $new(MultiSeparatorUI));
...
MultiSeparatorUI::MultiSeparatorUI() {
}
...
$Class* MultiSeparatorUI::class$ = nullptr;
