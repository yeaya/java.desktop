...
class $export SynthProgressBarUI : public ::javax::swing::plaf::basic::BasicProgressBarUI, public ::javax::swing::plaf::synth::SynthUI, public ::java::beans::PropertyChangeListener {
