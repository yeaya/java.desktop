...
class $export SynthPopupMenuUI : public ::javax::swing::plaf::basic::BasicPopupMenuUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
