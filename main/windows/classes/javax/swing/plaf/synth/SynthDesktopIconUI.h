#ifndef _javax_swing_plaf_synth_SynthDesktopIconUI_h_
#define _javax_swing_plaf_synth_SynthDesktopIconUI_h_
...
namespace javax {
	namespace swing {
		namespace plaf {
			namespace synth {
				class SynthContext;
				class SynthDesktopIconUI$Handler;
				class SynthStyle;
			}
		}
	}
...
class $export SynthDesktopIconUI : public ::javax::swing::plaf::basic::BasicDesktopIconUI, public ::javax::swing::plaf::synth::SynthUI, public ::java::beans::PropertyChangeListener {
	$class(SynthDesktopIconUI, $NO_CLASS_INIT, ::javax::swing::plaf::basic::BasicDesktopIconUI, ::javax::swing::plaf::synth::SynthUI, ::java::beans::PropertyChangeListener)
public:
	SynthDesktopIconUI();
	...
	void init$();
	static ::javax::swing::JInternalFrame* access$000(::javax::swing::plaf::synth::SynthDesktopIconUI* x0);
	static ::javax::swing::JInternalFrame* access$100(::javax::swing::plaf::synth::SynthDesktopIconUI* x0);
	static ::javax::swing::JInternalFrame* access$200(::javax::swing::plaf::synth::SynthDesktopIconUI* x0);
	static ::javax::swing::JInternalFrame* access$300(::javax::swing::plaf::synth::SynthDesktopIconUI* x0);
	...
	::javax::swing::plaf::synth::SynthDesktopIconUI$Handler* handler = nullptr;
};
...
#endif // _javax_swing_plaf_synth_SynthDesktopIconUI_h_