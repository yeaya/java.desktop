...
class $export SynthDesktopPaneUI : public ::javax::swing::plaf::basic::BasicDesktopPaneUI, public ::java::beans::PropertyChangeListener, public ::javax::swing::plaf::synth::SynthUI {
