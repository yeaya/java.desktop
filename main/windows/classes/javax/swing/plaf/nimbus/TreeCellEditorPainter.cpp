...
$MethodInfo _TreeCellEditorPainter_MethodInfo_[] = {
	{"<init>", "(Ljavax/swing/plaf/nimbus/AbstractRegionPainter$PaintContext;I)V", nullptr, $PUBLIC, $method(static_cast<void(TreeCellEditorPainter::*)($AbstractRegionPainter$PaintContext*,int32_t)>(&TreeCellEditorPainter::init$))},
	{"decodePath1", "()Ljava/awt/geom/Path2D;", nullptr, $PRIVATE, $method(static_cast<$Path2D*(TreeCellEditorPainter::*)()>(&TreeCellEditorPainter::decodePath1))},
	{"decodePath2", "()Ljava/awt/geom/Path2D;", nullptr, $PRIVATE, $method(static_cast<$Path2D*(TreeCellEditorPainter::*)()>(&TreeCellEditorPainter::decodePath2))},
	...
	{"paintBackgroundEnabled", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(static_cast<void(TreeCellEditorPainter::*)($Graphics2D*)>(&TreeCellEditorPainter::paintBackgroundEnabled))},
	{"paintBackgroundEnabledAndFocused", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(static_cast<void(TreeCellEditorPainter::*)($Graphics2D*)>(&TreeCellEditorPainter::paintBackgroundEnabledAndFocused))},
	{}
};
