...
class $export BasicMenuItemUI$Handler : public ::javax::swing::event::MenuDragMouseListener, public ::javax::swing::event::MouseInputListener, public ::java::beans::PropertyChangeListener {
