#ifndef _javax_swing_plaf_basic_BasicBorders$ButtonBorder_h_
#define _javax_swing_plaf_basic_BasicBorders$ButtonBorder_h_
...
class $export BasicBorders$ButtonBorder : public ::javax::swing::border::AbstractBorder, public ::javax::swing::plaf::UIResource {
	$class(BasicBorders$ButtonBorder, $NO_CLASS_INIT, ::javax::swing::border::AbstractBorder, ::javax::swing::plaf::UIResource)
public:
...
#endif // _javax_swing_plaf_basic_BasicBorders$ButtonBorder_h_