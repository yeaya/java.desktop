...
class $export BasicScrollPaneUI$Handler : public ::javax::swing::event::ChangeListener, public ::java::beans::PropertyChangeListener, public ::java::awt::event::MouseWheelListener {
