#ifndef _javax_swing_plaf_basic_BasicTabbedPaneUI_h_
#define _javax_swing_plaf_basic_BasicTabbedPaneUI_h_
...
namespace javax {
	namespace swing {
		namespace plaf {
			namespace basic {
				class BasicTabbedPaneUI$Handler;
				class BasicTabbedPaneUI$ScrollableTabSupport;
				class BasicTabbedPaneUI$TabContainer;
				class LazyActionMap;
			}
		}
	}
...
class $export BasicTabbedPaneUI : public ::javax::swing::plaf::TabbedPaneUI, public ::javax::swing::SwingConstants {
...
public:
	...
	::javax::swing::plaf::basic::BasicTabbedPaneUI$Handler* getHandler();
	...
	::javax::swing::plaf::basic::BasicTabbedPaneUI$ScrollableTabSupport* tabScroller = nullptr;
	::javax::swing::plaf::basic::BasicTabbedPaneUI$TabContainer* tabContainer = nullptr;
	::java::awt::Rectangle* calcRect = nullptr;
	int32_t focusIndex = 0;
	::javax::swing::plaf::basic::BasicTabbedPaneUI$Handler* handler = nullptr;
...
#endif // _javax_swing_plaf_basic_BasicTabbedPaneUI_h_