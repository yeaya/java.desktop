...
class $export JFrame : public ::java::awt::Frame, public ::javax::swing::WindowConstants, public ::javax::swing::RootPaneContainer, public ::javax::swing::TransferHandler$HasGetTransferHandler {
