#ifndef _javax_swing_JTable$AccessibleJTable$AccessibleJTableHeaderCell_h_
#define _javax_swing_JTable$AccessibleJTable$AccessibleJTableHeaderCell_h_
//$ class javax.swing.JTable$AccessibleJTable$AccessibleJTableHeaderCell
...
class JTable$AccessibleJTable$AccessibleJTableHeaderCell : public ::javax::accessibility::AccessibleContext, public ::javax::accessibility::Accessible, public ::javax::accessibility::AccessibleComponent {
	$class(JTable$AccessibleJTable$AccessibleJTableHeaderCell, $NO_CLASS_INIT, ::javax::accessibility::AccessibleContext, ::javax::accessibility::Accessible, ::javax::accessibility::AccessibleComponent)
public:
	...
	void init$(::javax::swing::JTable$AccessibleJTable* this$1, int32_t row, int32_t column, ::javax::swing::table::JTableHeader* parent, ::java::awt::Component* rendererComponent);
	...
	::java::awt::Component* rendererComponent = nullptr;
};

	} // swing
} // javax

#endif // _javax_swing_JTable$AccessibleJTable$AccessibleJTableHeaderCell_h_