...
class $export JSpinner$DefaultEditor : public ::javax::swing::JPanel, public ::javax::swing::event::ChangeListener, public ::java::beans::PropertyChangeListener, public ::java::awt::LayoutManager {
