...
class $export JInternalFrame : public ::javax::swing::JComponent, public ::javax::accessibility::Accessible, public ::javax::swing::WindowConstants, public ::javax::swing::RootPaneContainer {
