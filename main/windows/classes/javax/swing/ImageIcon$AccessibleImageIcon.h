...
class $export ImageIcon$AccessibleImageIcon : public ::javax::accessibility::AccessibleContext, public ::javax::accessibility::AccessibleIcon, public ::java::io::Serializable {
