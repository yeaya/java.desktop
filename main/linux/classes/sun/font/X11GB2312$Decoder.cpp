...
$MethodInfo _X11GB2312$Decoder_MethodInfo_[] = {
	{"<init>", "(Lsun/font/X11GB2312;Ljava/nio/charset/Charset;)V", nullptr, $PUBLIC, $method(static_cast<void(X11GB2312$Decoder::*)($X11GB2312*,$Charset*)>(&X11GB2312$Decoder::init$))},
