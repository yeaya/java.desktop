...
public:
	...
	static const int32_t WIN_STATE_STICKY = (1 << 0);
	static const int32_t WIN_STATE_MINIMIZED = (1 << 1);
	static const int32_t WIN_STATE_MAXIMIZED_VERT = (1 << 2);
	static const int32_t WIN_STATE_MAXIMIZED_HORIZ = (1 << 3);
	static const int32_t WIN_STATE_HIDDEN = (1 << 4);
	static const int32_t WIN_STATE_SHADED = (1 << 5);
