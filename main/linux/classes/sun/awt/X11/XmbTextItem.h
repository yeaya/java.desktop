#ifndef _sun_awt_X11_XmbTextItem_h_
#define _sun_awt_X11_XmbTextItem_h_
//$ class sun.awt.X11.XmbTextItem
...
class XmbTextItem : public ::sun::awt::X11::XWrapperBase {
	$class(XmbTextItem, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XmbTextItem();
	...
	virtual int8_t get_chars(int32_t index);
...
#endif // _sun_awt_X11_XmbTextItem_h_