#ifndef _sun_awt_X11_XIMText_h_
#define _sun_awt_X11_XIMText_h_
//$ class sun.awt.X11.XIMText
...
class XIMText : public ::sun::awt::X11::XWrapperBase {
	$class(XIMText, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XIMText();
