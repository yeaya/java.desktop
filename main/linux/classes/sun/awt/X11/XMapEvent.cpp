...
$MethodInfo _XMapEvent_MethodInfo_[] = {
	{"<init>", "(J)V", nullptr, $PUBLIC, $method(static_cast<void(XMapEvent::*)(int64_t)>(&XMapEvent::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XMapEvent::*)()>(&XMapEvent::init$))},
	...
	{"getSize", "()I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)()>(&XMapEvent::getSize))},
	{"get_display", "()J", nullptr, $PUBLIC},
	{"get_event", "()J", nullptr, $PUBLIC},
	{"get_override_redirect", "()I", nullptr, $PUBLIC},
	...
	{"set_override_redirect", "(I)V", nullptr, $PUBLIC},
