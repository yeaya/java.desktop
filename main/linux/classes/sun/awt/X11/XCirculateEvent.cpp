...
$MethodInfo _XCirculateEvent_MethodInfo_[] = {
	{"<init>", "(J)V", nullptr, $PUBLIC, $method(static_cast<void(XCirculateEvent::*)(int64_t)>(&XCirculateEvent::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XCirculateEvent::*)()>(&XCirculateEvent::init$))},
	...
	{"getSize", "()I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)()>(&XCirculateEvent::getSize))},
