#ifndef _sun_awt_X11_XTextItem_h_
#define _sun_awt_X11_XTextItem_h_
//$ class sun.awt.X11.XTextItem
...
class XTextItem : public ::sun::awt::X11::XWrapperBase {
	$class(XTextItem, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XTextItem();
...
#endif // _sun_awt_X11_XTextItem_h_