...
$MethodInfo _XSelectionEvent_MethodInfo_[] = {
	{"<init>", "(J)V", nullptr, $PUBLIC, $method(static_cast<void(XSelectionEvent::*)(int64_t)>(&XSelectionEvent::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XSelectionEvent::*)()>(&XSelectionEvent::init$))},
	...
	{"getSize", "()I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)()>(&XSelectionEvent::getSize))},
