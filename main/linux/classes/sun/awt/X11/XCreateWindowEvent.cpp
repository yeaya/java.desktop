...
$MethodInfo _XCreateWindowEvent_MethodInfo_[] = {
	{"<init>", "(J)V", nullptr, $PUBLIC, $method(static_cast<void(XCreateWindowEvent::*)(int64_t)>(&XCreateWindowEvent::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XCreateWindowEvent::*)()>(&XCreateWindowEvent::init$))},
	...
	{"getSize", "()I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)()>(&XCreateWindowEvent::getSize))},
