...
$MethodInfo _JTextComponent$AccessibleJTextComponent$4_MethodInfo_[] = {
	{"<init>", "(Ljavax/swing/text/JTextComponent$AccessibleJTextComponent;Ljava/lang/Integer;)V", "()V", 0, $method(static_cast<void(JTextComponent$AccessibleJTextComponent$4::*)($JTextComponent$AccessibleJTextComponent*,$Integer*)>(&JTextComponent$AccessibleJTextComponent$4::init$))},
