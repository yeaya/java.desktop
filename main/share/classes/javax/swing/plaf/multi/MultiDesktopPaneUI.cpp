...
$FieldInfo _MultiDesktopPaneUI_FieldInfo_[] = {
	{"uis", "Ljava/util/Vector;", "Ljava/util/Vector<Ljavax/swing/plaf/ComponentUI;>;", $PROTECTED, $field(MultiDesktopPaneUI, uis)},
	{}
};

$MethodInfo _MultiDesktopPaneUI_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(MultiDesktopPaneUI::*)()>(&MultiDesktopPaneUI::init$))},
	{"contains", "(Ljavax/swing/JComponent;II)Z", nullptr, $PUBLIC},
	{"createUI", "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$ComponentUI*(*)($JComponent*)>(&MultiDesktopPaneUI::createUI))},
...
$ClassInfo _MultiDesktopPaneUI_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"javax.swing.plaf.multi.MultiDesktopPaneUI",
	"javax.swing.plaf.DesktopPaneUI",
	nullptr,
	_MultiDesktopPaneUI_FieldInfo_,
	_MultiDesktopPaneUI_MethodInfo_
};

$Object* allocate$MultiDesktopPaneUI($Class* clazz) {
	return $of($alloc(MultiDesktopPaneUI));
}

void MultiDesktopPaneUI::init$() {
	$DesktopPaneUI::init$();
	$set(this, uis, $new($Vector));
}

$ComponentUIArray* MultiDesktopPaneUI::getUIs() {
	return $MultiLookAndFeel::uisToArray(this->uis);
}

bool MultiDesktopPaneUI::contains($JComponent* a, int32_t b, int32_t c) {
...
$ComponentUI* MultiDesktopPaneUI::createUI($JComponent* a) {
	$init(MultiDesktopPaneUI);
	$var(MultiDesktopPaneUI, mui, $new(MultiDesktopPaneUI));
...
int32_t MultiDesktopPaneUI::getAccessibleChildrenCount($JComponent* a) {
	$useLocalCurrentObjectStackCache();
...
$Accessible* MultiDesktopPaneUI::getAccessibleChild($JComponent* a, int32_t b) {
	$useLocalCurrentObjectStackCache();
...
MultiDesktopPaneUI::MultiDesktopPaneUI() {
}

$Class* MultiDesktopPaneUI::load$($String* name, bool initialize) {
	$loadClass(MultiDesktopPaneUI, name, initialize, &_MultiDesktopPaneUI_ClassInfo_, allocate$MultiDesktopPaneUI);
	return class$;
}

$Class* MultiDesktopPaneUI::class$ = nullptr;
