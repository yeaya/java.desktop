...
$FieldInfo _MultiTableHeaderUI_FieldInfo_[] = {
	{"uis", "Ljava/util/Vector;", "Ljava/util/Vector<Ljavax/swing/plaf/ComponentUI;>;", $PROTECTED, $field(MultiTableHeaderUI, uis)},
	{}
};

$MethodInfo _MultiTableHeaderUI_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(MultiTableHeaderUI::*)()>(&MultiTableHeaderUI::init$))},
	{"contains", "(Ljavax/swing/JComponent;II)Z", nullptr, $PUBLIC},
	{"createUI", "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$ComponentUI*(*)($JComponent*)>(&MultiTableHeaderUI::createUI))},
...
$ClassInfo _MultiTableHeaderUI_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"javax.swing.plaf.multi.MultiTableHeaderUI",
	"javax.swing.plaf.TableHeaderUI",
	nullptr,
	_MultiTableHeaderUI_FieldInfo_,
	_MultiTableHeaderUI_MethodInfo_
};

$Object* allocate$MultiTableHeaderUI($Class* clazz) {
	return $of($alloc(MultiTableHeaderUI));
}

void MultiTableHeaderUI::init$() {
	$TableHeaderUI::init$();
	$set(this, uis, $new($Vector));
}

$ComponentUIArray* MultiTableHeaderUI::getUIs() {
	return $MultiLookAndFeel::uisToArray(this->uis);
}

bool MultiTableHeaderUI::contains($JComponent* a, int32_t b, int32_t c) {
...
$ComponentUI* MultiTableHeaderUI::createUI($JComponent* a) {
	$init(MultiTableHeaderUI);
	$var(MultiTableHeaderUI, mui, $new(MultiTableHeaderUI));
...
int32_t MultiTableHeaderUI::getAccessibleChildrenCount($JComponent* a) {
	$useLocalCurrentObjectStackCache();
...
$Accessible* MultiTableHeaderUI::getAccessibleChild($JComponent* a, int32_t b) {
	$useLocalCurrentObjectStackCache();
...
MultiTableHeaderUI::MultiTableHeaderUI() {
}

$Class* MultiTableHeaderUI::load$($String* name, bool initialize) {
	$loadClass(MultiTableHeaderUI, name, initialize, &_MultiTableHeaderUI_ClassInfo_, allocate$MultiTableHeaderUI);
	return class$;
}

$Class* MultiTableHeaderUI::class$ = nullptr;
