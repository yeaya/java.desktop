...
$MethodInfo _WindowsKeybindings_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(WindowsKeybindings::*)()>(&WindowsKeybindings::init$))},
	{"installKeybindings", "(Ljavax/swing/UIDefaults;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($UIDefaults*)>(&WindowsKeybindings::installKeybindings))},
	{}
};

$ClassInfo _WindowsKeybindings_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.swing.plaf.WindowsKeybindings",
	"java.lang.Object",
	nullptr,
	nullptr,
	_WindowsKeybindings_MethodInfo_
};

$Object* allocate$WindowsKeybindings($Class* clazz) {
	return $of($alloc(WindowsKeybindings));
}
...
$Class* WindowsKeybindings::load$($String* name, bool initialize) {
	$loadClass(WindowsKeybindings, name, initialize, &_WindowsKeybindings_ClassInfo_, allocate$WindowsKeybindings);
	return class$;
}
