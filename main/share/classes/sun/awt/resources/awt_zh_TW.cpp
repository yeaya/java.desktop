...
$MethodInfo _awt_zh_TW_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(awt_zh_TW::*)()>(&awt_zh_TW::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _awt_zh_TW_ClassInfo_ = {
	$PUBLIC | $FINAL | $ACC_SUPER,
	"sun.awt.resources.awt_zh_TW",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_awt_zh_TW_MethodInfo_
};

$Object* allocate$awt_zh_TW($Class* clazz) {
	return $of($alloc(awt_zh_TW));
}
...
$ObjectArray2* awt_zh_TW::getContents() {
...
$Class* awt_zh_TW::load$($String* name, bool initialize) {
	$loadClass(awt_zh_TW, name, initialize, &_awt_zh_TW_ClassInfo_, allocate$awt_zh_TW);
	return class$;
}

$Class* awt_zh_TW::class$ = nullptr;
