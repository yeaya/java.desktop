...
class $import DefaultListSelectionModel : public ::javax::swing::ListSelectionModel, public ::java::lang::Cloneable, public ::java::io::Serializable {
...
public:
	...
	static const int32_t MAX = ::java::lang::Integer::MAX_VALUE;
